...
| **1.3** Database | PostgreSQL + Alembic; asset/document/job schemas | Planned |
...
| **1.8** Frontend Shell | Next.js nav shell; enterprise sidebar routes | Planned |
...
**Current engineering focus:** Milestone **1.3 — Database** (next implementation step; awaiting approval).
